        ...
        <div class="row">
            ...
            if ($result->num_rows > 0) {
                while ($curso = $result->fetch_assoc()) {
                    ...
                    echo '<img src="' . $foto . '" alt="'  . '" class="card-img-top" "' . htmlspecialchars($curso['titulo']) . '">';
                    echo '<div class="card-body">';
                    echo '<h5 class="card-title">' . htmlspecialchars($curso['titulo']) . '</h5>';
                    echo '<p class="card-text">' . htmlspecialchars($curso['descripcion']) . '</p>';
                    echo '<a href="./inscripcion.php"' . htmlspecialchars($curso['id']) . '" class="btn btn-primary">Inscribirse</a>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                }
